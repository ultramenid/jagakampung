        ...
        <form wire:submit.prevent="storeDatabase">
            <div class="space-y-5">
                ...
                <div>
                    ...
                    @if ($gambar)
                        <img src="{{ asset('storage/' . $gambar) }}" class="w-24 rounded mb-2">
                    @endif
            ...
            <div class="flex items-center gap-3 mt-6 pt-6 border-t border-gray-100">
                ...
                {{-- button delete --}}
                <button type="button" wire:click="deleteArtikel" wire:confirm="Yakin ingin menghapus artikel ini?"
                    class="px-4 py-2.5 text-xs font-medium text-red-600 border border-red-200 rounded-lg hover:bg-red-50 transition cursor-pointer">
                    Hapus
                </button>
