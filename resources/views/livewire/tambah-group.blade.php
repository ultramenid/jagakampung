<div class="max-w-3xl px-4 mx-auto py-8">
    <div class="flex items-center gap-3 mb-6">
        <a href="/cms/group" class="text-xs text-gray-400 hover:text-gray-700 transition">Group</a>
        <span class="text-gray-200">/</span>
        <span class="text-xs text-gray-600 font-medium">Tambah Group</span>
    </div>

    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 max-w-xl">
        <h1 class="text-sm font-semibold text-gray-900 mb-6">Tambah Group</h1>

        <form wire:submit.prevent="storeDatabase">
            <div class="space-y-4">
                <div>
                    <label class="block text-xs font-medium text-gray-600 mb-1.5">Nama Group</label>
