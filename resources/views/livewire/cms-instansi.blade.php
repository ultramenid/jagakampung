<div class="max-w-3xl px-4 mx-auto py-8">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-sm font-semibold text-gray-900">Instansi</h1>
            <p class="text-xs text-gray-400 mt-0.5">Kelola data instansi</p>
        </div>
        <a href="/cms/tambah-instansi"
    ...
    <div class="mb-4">
        <input wire:model.live="search" type="search" placeholder="Cari instansi…"
        ...
        <table class="w-full text-xs">
            <thead>
                <tr class="border-b border-gray-100">
                    <th class="text-left px-4 py-3 text-[10px] font-bold uppercase tracking-widest text-gray-400">Nama Instansi</th>
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                @empty
                <tr>
                    <td colspan="3" class="px-4 py-10 text-center text-xs text-gray-400">Belum ada data instansi</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    {{-- <div class="mt-4">@include('livewire.pagination', ['paginator' => $instansis])</div> --}}
</div>
