<div class="max-w-3xl px-4 mx-auto py-8">
    ...
    <div class="gk-card p-6 max-w-xl">
        <h1 class="text-base font-semibold text-gray-900 mb-6">Tambah Pengguna</h1>

        <form wire:submit.prevent="storeDatabase">
            <div class="space-y-4">
                <div>
                    <label class="gk-label">Nama Lengkap</label>
                    <input wire:model="nama" type="text" class="gk-input @error('nama') border-red-300 @enderror" placeholder="Masukkan nama lengkap">
                ...
                <div>
                    ...
                    <input wire:model="password" type="password" class="gk-input @error('password') border-red-300 @enderror" placeholder="••••••••">
