<div class="min-h-screen bg-gray-50 py-8 px-4 max-w-3xl mx-auto mt-2 rounded">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl border border-gray-200">
            ...
            <div x-data="{
            ...
            }" @click.outside="open = false" @close-region.window="open = false" class="relative z-[500]">
                ...
                <div x-show="open" style="display: none;" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                    ...
                    <div class="max-h-40 overflow-y-auto" @scroll="handleScroll($el)">
                        ...
                        @endforelse
                        @if ($searchHasMore)
                            <div wire:loading.class.remove="hidden" wire:target="loadMoreResults" class="hidden flex items-center justify-center gap-2 py-3 text-sm text-gray-500">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <div>
                ...
                <textarea wire:model="deskripsiperjuangan" rows="6" placeholder="Jelaskan upaya perjuangan yang telah dilakukan..."
                    class="w-full bg-white border border-gray-300 rounded-xl py-2.5 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 transition-colors "></textarea>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div wire:loading wire:target="images" class="flex items-center gap-2 mt-3 text-sm text-gray-500">
                        <svg class="animate-spin h-4 w-4 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path>
                        </svg>
                    ...
                    @if ($images)
                        <div class="grid grid-cols-3 gap-3 mt-4">
                            @foreach ($images as $index => $image)
                                <div class="relative group rounded-xl overflow-hidden border border-gray-200" wire:key="img-{{ $index }}">
