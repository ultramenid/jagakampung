<div class="min-h-screen bg-gray-50 py-8 px-4 max-w-3xl mx-auto mt-2 rounded">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        {{-- Header --}}
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900">Tambah Data Konflik</h1>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200">
                <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 bg-gray-50 rounded-t-2xl">
                    <div
                        class="flex items-center justify-center w-8 h-8 rounded-full bg-gray-900 text-white text-xs font-bold shrink-0">
                        1</div>
                    <div>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="w-full h-80 rounded-xl overflow-hidden border border-gray-200 z-10" id="map"
                        wire:ignore></div>
                    ...
                    <div x-data="{
                        ...
                        <div @click="open = !open; if(open) $nextTick(() => $refs.regionInput.focus())"
                            class="flex items-center justify-between w-full bg-white border border-gray-300 rounded-xl py-2.5 px-4 cursor-pointer hover:border-gray-400 transition-colors text-sm">
                            <span
                                class="{{ $desa ? 'text-gray-900' : 'text-gray-400' }} truncate">{{ $region }}</span>
                            <svg class="h-4 w-4 text-gray-400 shrink-0 ml-2" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div x-show="open" style="display: none;" x-transition:enter="transition ease-out duration-100"
                            ...
                            class="absolute z-[500] w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden">
                            <div class="p-2 border-b border-gray-100">
                                <div class="relative">
                                    <input x-ref="regionInput" wire:model.live.debounce.200ms="chooseRegion"
                                        type="text"
                                        class="w-full rounded-lg bg-gray-50 border border-gray-200 py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 pr-9"
                                        placeholder="Cari nama desa..." />
                                    <div wire:loading wire:target="chooseRegion"
                            ...
                            <div class="max-h-40 overflow-y-auto" @scroll="handleScroll($el)">
                                ...
                                @empty
                                    <div class="px-4 py-6 text-center text-sm text-gray-400">Ketik minimal 3 karakter
                                        untuk mencari</div>
                                @endforelse
                                @if ($searchHasMore)
                                    <div wire:loading.class.remove="hidden" wire:target="loadMoreResults"
                                        ...
                                        <svg class="animate-spin h-4 w-4 shrink-0 text-gray-400"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                            <circle class="opacity-25" cx="12" cy="12" r="10"
                                                stroke="currentColor" stroke-width="4"></circle>
                                            <path class="opacity-75" fill="currentColor"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input placeholder="Dipilih dari peta" disabled type="text" wire:model="latitude"
                        ...
                        <div>
                            ...
                            <input placeholder="Dipilih dari peta" disabled type="text" wire:model="longtitude"
                                class="w-full bg-gray-50 text-gray-500 border border-gray-200 rounded-xl py-2.5 px-4 text-sm focus:outline-none" />
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model="selectedPerusahaan"
                                ...
                                <option value="">{{ $selectedGroup ? 'Pilih perusahaan' : 'Pilih group dulu' }}
                                </option>
                                @foreach ($perusahaans as $perusahaan)
                                    <option value="{{ $perusahaan->perusahaan }}">{{ $perusahaan->perusahaan }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Luas <span
                                    class="text-gray-400 font-normal">(ha)</span></label>
                        ...
                        <div x-data="{ open: @entangle('isPelaku') }">
                            <div @click="open = !open"
                                ...
                                @forelse ($lembagas as $key => $value)
                                    <span
                                        class="inline-flex items-center gap-1 bg-gray-900 text-white text-xs rounded-full py-1 px-3">
                                        {{ $value }}
                                        <svg wire:click.stop="deleteTags({{ $key }})"
                                            class="h-3 w-3 cursor-pointer hover:text-gray-300" viewBox="0 0 20 20"
                                            fill="currentColor">
                                            <path fill-rule="evenodd"
                            ...
                            <div x-show="open" style="display: none;"
                                ...
                                x-transition:enter-end="opacity-100 scale-100" @click.outside="open = false"
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea wire:model="deskripsikonflik" rows="6" placeholder="Jelaskan latar belakang dan kronologi konflik..."
                    ...
                    <div>
                        ...
                        <textarea wire:model="deskripsiperjuangan" rows="6"
                            placeholder="Jelaskan upaya perjuangan yang telah dilakukan..."
                            class="w-full bg-white border border-gray-300 rounded-xl py-2.5 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 transition-colors "></textarea>
                    </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <label
                            class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 hover:border-gray-400 transition-colors">
                        ...
                        <div wire:loading wire:target="images"
                            class="flex items-center gap-2 mt-3 text-sm text-gray-500">
            ...
            <div class="flex items-center justify-between pt-2 pb-12">
                ...
                <button wire:click="storeDatabase" wire:loading.attr="disabled"
