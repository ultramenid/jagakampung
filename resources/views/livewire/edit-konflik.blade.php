<div class="min-h-screen bg-gray-50 py-8 px-4 max-w-3xl mx-auto mt-2">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-semibold tracking-tight text-gray-900">Edit Data Konflik</h1>
        </div>
        ...
        <div class="gk-card">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input disabled placeholder="Dipilih dari peta" type="text" wire:model="latitude" class="gk-input gk-mono bg-gray-50 text-gray-500" />
                </div>
                <div>
                    <label class="gk-label">Longitude</label>
                    <input disabled placeholder="Dipilih dari peta" type="text" wire:model="longtitude" class="gk-input gk-mono bg-gray-50 text-gray-500" />
                </div>
            </div>
        ...
        <div class="gk-card overflow-hidden">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div>
                    <label class="gk-label">Jumlah Jiwa Berkonflik</label>
                    <input placeholder="0" type="number" wire:model="jiwa" class="gk-input gk-mono" />
                </div>
                <div>
        ...
        <div class="gk-card overflow-hidden">
            ...
            <div class="p-6 space-y-5">
                <div>
                    ...
                    <textarea wire:model="deskripsikonflik" rows="4" placeholder="Jelaskan latar belakang dan kronologi konflik…" class="gk-input h-auto py-2.5 resize-none"></textarea>
                </div>
                <div>
                    <label class="gk-label">Deskripsi Perjuangan</label>
                    <textarea wire:model="deskripsiperjuangan" rows="4" placeholder="Jelaskan upaya perjuangan yang telah dilakukan…" class="gk-input h-auto py-2.5 resize-none"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="gk-card overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    @if ($images)
                        <div class="mb-4">
                            <p class="font-mono text-[10px] uppercase tracking-wider text-gray-400 mb-2">Foto tersimpan</p>
                            <div class="grid grid-cols-3 gap-3">
                                @foreach ($images as $index => $image)
                                    <div class="relative group rounded-md overflow-hidden border border-gray-200" wire:key="old-img-{{ $index }}">
                    ...
                    @if ($newImages)
                        <div class="grid grid-cols-3 gap-3 mt-4">
                            @foreach ($newImages as $index => $image)
                                <div class="relative group rounded-md overflow-hidden border border-gray-200" wire:key="new-img-{{ $index }}">
                                    <img src="{{ $image->temporaryUrl() }}" class="w-full h-28 object-cover">
                                    <div class="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-colors flex items-center justify-center">
                                        <button type="button" wire:click="removeNewImage({{ $index }})" class="opacity-0 group-hover:opacity-100 transition-opacity bg-white rounded-full p-1.5 shadow">
                                            <svg class="h-4 w-4 text-red-500" viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                                            </svg>
                                        </button>
