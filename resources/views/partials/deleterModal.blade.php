    ...
    <div class="fixed inset-0 z-[9999] flex items-center justify-center p-4"
        ...
        <div role="dialog" aria-modal="true" aria-labelledby="deleterDialogTitle"
            ...
            <div class="flex gap-3 mt-6">
                ...
                <button wire:loading.inline-flex wire:target="closeDelete" type="button" class="gk-btn-secondary gk-btn-sm flex-1" disabled>Batal</button>
                ...
                <button wire:loading.inline-flex wire:target="deleting({{ $deleteID }})" type="button" class="gk-btn gk-btn-sm flex-1 bg-red-600 text-white" disabled>
