...
<div class="max-w-3xl px-4 mx-auto py-10">
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-wrap items-end gap-4">
            <span class="font-mono text-[clamp(2.25rem,7vh,3.75rem)] font-semibold text-gray-900 tabular-nums leading-none">
                {{ $fmt($stats['konflik']) }}
            </span>
        ...
        <div class="mt-5 flex flex-wrap items-center gap-x-8 gap-y-2 text-sm text-gray-600">
            ...
            <span><span class="gk-mono font-semibold text-gray-900">{{ $fmt($stats['kk']) }}</span> KK</span>
            <span><span class="gk-mono font-semibold text-gray-900">{{ $fmt($stats['jiwa']) }}</span> jiwa</span>
        </div>
    </div>
